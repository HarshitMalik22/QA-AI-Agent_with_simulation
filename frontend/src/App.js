    ...
    <div className="App">
      ...
      <main className="dashboard-grid">
        ...
        <section className="results-section">
          {!analysis ? (
            <div className="card glass-card" style={{ textAlign: 'center', padding: '4rem', color: 'var(--text-tertiary)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>👋</div>
              <h3>Ready to simulate</h3>
              <p>Select a sample call or paste a transcript to begin counterfactual analysis.</p>
            </div>
          ) : (
            <>
              {/* Top Row: Map & KPIs */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
                <div className="card">
                  ...
                  <StationMap
                    stations={stations}
                    driverLocation={driverLocation.lat ? driverLocation : null}
